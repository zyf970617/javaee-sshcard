    ...
    <head>
        ...
        <script>
        	...
        	function moveToTrash() {
                ...
                if (r==true) {
                	window.location.href="movecardsToTrash?ids="+encodeURI(JSON.stringify(value))+"&page="+_page+"&sum="+_sum;
                }
        	}
        	/* 导出excel */
        	...
        	function deleteSelect() {
                ...
                if (r==true) {
                	window.location.href="deletecards?ids="+encodeURI(JSON.stringify(value))
                }
        	}
        	/* 跳转到回收站 */
		    	...
		    	<form action="../card/excelCard" method="post" enctype="multipart/form-data">
			        <div class="modal-content">
			            ...
			            <div class="modal-body" style="padding: 20px;">
							...
							<input required="true" type="file" class="form-control" name="file"/>
			            </div>
